...
pub fn checkpoint_list_input_schema() -> Value {
...
pub fn checkpoint_show_input_schema() -> Value {
    checkpoint_project_input_schema(vec![
        ("project", "string", "Runtime project id.", true),
        (
            "checkpoint_id",
...
pub fn checkpoint_restore_input_schema() -> Value {
    checkpoint_project_input_schema(vec![
        ("project", "string", "Runtime project id.", true),
...
pub fn checkpoint_delete_input_schema() -> Value {
    checkpoint_project_input_schema(vec![
        ("project", "string", "Runtime project id.", true),
...
pub fn checkpoint_validation_schema(description: &str) -> Value {
    json!({
        "type": "object",
...
pub fn checkpoint_labels_schema(description: &str) -> Value {
    json!({
        "type": "array",
        "items": {
            "type": "string",
...
pub fn checkpoint_create_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "project": {
