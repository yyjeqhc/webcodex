...
pub const TOOL_MANIFEST_INTENTS: &[ToolManifestIntent] = &[
    ...
    ToolManifestIntent {
        name: "release",
        purpose: "Release and deployment closeout: runtime/public-ingress evidence, preflight authority/readiness, hygiene, validation, jobs status, changes, finish.",
        tools: &[
            "runtime_status",
            "runtime_diagnostics",
            "deployment_preflight",
