...
- `webcodex-cli agent status --profile special` can read the local agent config.
- `webcodex-cli doctor --strict --profile special --server-url https://your-domain.example` passes.
