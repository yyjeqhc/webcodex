...
const SOURCE_BYTES_MARKER: &str = "WEBPI_CHANGES_SOURCE_BYTES=";
const DIFF_BYTES_MARKER: &str = "WEBPI_CHANGES_DIFF_BYTES=";
const DIFF_LINES_MARKER: &str = "WEBPI_CHANGES_DIFF_LINES=";
