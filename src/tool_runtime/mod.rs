...
+remote\n"
    ...
    async fn start_session_without_project_instructions_when_no_candidate_exists() {
        ...
        for expected_path in super::project_instructions::INSTRUCTION_CANDIDATE_PATHS {
    ...
    async fn start_session_truncates_large_instruction_file() {
        ...
        let body = (0..(super::project_instructions::MAX_LINES_PER_FILE + 1))
        ...
        assert_eq!(
            ...
            super::project_instructions::MAX_LINES_PER_FILE + 1
        );
        assert_eq!(
            read_more["limit"],
            super::project_instructions::MAX_LINES_PER_FILE
        );
    ...
    fn apply_text_edits_insert_before_after_unique_anchor() {
        ...
        let err =
            files::apply_text_edits_to_string(dup, "src/x.rs", &edits, None, false).unwrap_err();
        assert!(err.contains("matched 2 times"));
    }
