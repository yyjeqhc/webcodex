...
pub(super) fn create_project_input_schema() -> Value {
    object_schema(vec![
        ("client_id", "string", "Registered agent client_id.", true),
        (
            "id",
...
pub(super) fn run_shell_input_schema() -> Value {
...
pub(super) fn run_job_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        ("project", "string", "Configured project id.", true),
        (
            "command",
...
pub(super) fn stop_job_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        (
            "project",
            "string",
...
pub(super) fn run_codex_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        ("project", "string", "Configured project id.", true),
        (
            "prompt",
...
pub(super) fn job_status_input_schema() -> Value {
    object_schema(vec![
...
pub(super) fn job_log_input_schema() -> Value {
    object_schema(vec![
        ("job_id", "string", "Job id.", true),
        (
            "offset",
...
pub(super) fn list_jobs_input_schema() -> Value {
    object_schema(vec![
        (
            "limit",
            "integer",
...
pub(super) fn job_tail_input_schema() -> Value {
    object_schema(vec![
        ("job_id", "string", "Job id.", true),
        (
            "tail_lines",
...
pub(super) fn list_project_files_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
...
pub(super) fn search_project_text_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        ("project", "string", "Agent-registered project id.", true),
...
pub(super) fn read_file_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        ("project", "string", "Configured project id.", true),
...
pub(super) fn cargo_check_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        ("project", "string", "Agent-registered project id.", true),
        (
            "cwd",
...
pub(super) fn cargo_test_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        ("project", "string", "Agent-registered project id.", true),
        (
            "cwd",
...
pub(super) fn validate_patch_input_schema() -> Value {
    object_schema(with_optional_session_id(vec![
        ("project", "string", "Agent-registered project id.", true),
